<div class="card shadow-sm">
    <div class="card-header">
        <h5 class="mb-0 fw-bold">Nhập thông tin Chuyên khoa mới</h5>
    </div>
    <div class="card-body p-4">
        <form action="/admin/specialties/store" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="MoTa" name="MoTa" rows="4" placeholder="Mô tả ngắn về chuyên khoa..."></textarea>
            </div>
