...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold"><i class="fas fa-stethoscope me-2"></i>Quản lý Chuyên khoa</h5>
        <a href="/admin/specialties/create" class="btn btn-primary"><i class="fas fa-plus me-2"></i> Thêm mới</a>
    </div>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (empty($specialties)): ?>
                        <tr><td colspan="3" class="text-center p-5 text-muted">Chưa có chuyên khoa nào.</td></tr>
                    <?php else: ?>
                        <?php foreach ($specialties as $specialty): ?>
                            <tr>
                                <td class="fw-bold"><?= htmlspecialchars($specialty['TenChuyenKhoa']) ?></td>
                                <td><?= htmlspecialchars(mb_substr($specialty['MoTa'], 0, 120)) . (mb_strlen($specialty['MoTa']) > 120 ? '...' : '') ?></td>
                                <td class="text-end">
                                    <a href="/admin/specialties/<?= $specialty['ChuyenKhoaID'] ?>/edit" class="btn btn-sm btn-outline-primary" title="Chỉnh sửa">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="/admin/specialties/<?= $specialty['ChuyenKhoaID'] ?>/delete" method="POST" class="d-inline">
...
<div id="confirmDeleteModal" class="confirm-modal">
    ...
    <div class="confirm-container">
        ...
        <div class="confirm-content">
            <h3>Xác nhận xóa chuyên khoa</h3>
            <p>Bạn có chắc chắn muốn xóa chuyên khoa này? Hành động này không thể hoàn tác và có thể ảnh hưởng đến dữ liệu bác sĩ liên quan.</p>
        </div>
